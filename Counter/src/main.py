    ...
    footer = ft.Container(
                            content=ft.Column(
                                [
                                    ...
                                    ft.Text("© 2013 a 2025 - Universidade Federal de São Paulo - Unifesp", size=15, color=ft.Colors.WHITE, text_align=ft.TextAlign.CENTER, selectable=True),
                                    ft.Container(height=5),
                                    ft.Text("Rua Sena Madureira, n.º 1.500 - Vila Clementino - São Paulo - SP - CEP: 04021-001", text_align=ft.TextAlign.CENTER, size=13, color=ft.Colors.WHITE, selectable=True),
                                    ft.Container(height=10),
                                    ft.Text("Developed by: Laboratório de Bioinformática e Proteômica - UNIFESP", size=13, color=ft.Colors.WHITE, italic=True, 
                                            font_family="Cinzel", text_align=ft.TextAlign.CENTER, selectable=True),
                                    ft.Container(height=10),
                                ],
                                col={"md":3},
                                alignment=ft.MainAxisAlignment.CENTER,
                    ...
                    [
                        ...
                        ft.ResponsiveRow(
                            [
                                ft.Column(
                                    [
                                        ft.Text("PSAP", size=35, weight="bold", color=ft.Colors.GREEN_700, font_family="Cinzel", text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("PEAKS Spectra analyser by Amino acid Position: A tool to count the " \
                                        "number of spectra that cover each amino acid of a given protein, highlighting " \
                                        "Complementarity-Determining Regions.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Container(height=20),
                                        ft.Text("Instructions:", size=25, weight="bold", color=ft.Colors.GREEN_700, font_family="Cinzel", text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("1. Upload a CSV file generated by PEAKS containing at least the following columns: " \
                                        "'Protein Accession', 'Start', 'End', and 'Peptide'.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("2. Select the Protein Accession of interest from the dropdown menu.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("3. Click the 'Submit' button to generate the spectra count graph.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("4. In the 'Interactive Graph' tab, hover over the bars to see detailed " \
                                        "information about each amino acid position.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                        ft.Text("5. Navigate to the 'Results' tab to view the interactive graph and " \
                                        "export options.", size=16, text_align=ft.TextAlign.LEFT, selectable=True),
                                    ],
                                ...
                                ft.Container(
                                    ...
                                    content=ft.Column(
                                        [
                                            ...
                                            ft.Container(height=page.height*0.01),
